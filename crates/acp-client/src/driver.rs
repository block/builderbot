...
mod tests {
    ...
    use super::{
        ...
        select_auth_method, send_session_setup_request, setup_acp_session, shell_exec_line,
        shell_quote, task_tracking_mode_from_initialize, AcpDriver, AcpEventMetadata,
