...
pub use driver::{
    ...
    labeled_background_continuation_origin, strip_code_fences, AcpAuthenticationSelection,
    AcpDriver, AcpEventMetadata, AcpInitializeMetadata, AcpPermissionDecision, AcpPermissionOption,
    AcpPermissionOptionKind, AcpPermissionRequest, AcpSessionConfigOptionSelection,
    AcpToolCallMetadata, AgentDriver, AgentRunOutcome, AsyncTaskStopHandle, BackgroundHoldConfig,
    BackgroundHoldObserver, BackgroundHoldStatus, BackgroundHoldTask, BasicMessageWriter,
    MessageWriter, OutOfTurnPermissionPolicy, ReplayBoundary, SessionConnection, SessionLifetime,
